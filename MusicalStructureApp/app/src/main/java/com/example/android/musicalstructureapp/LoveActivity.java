...
public class LoveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        music.add(new Music("Whitney Houston", "I will always love you",R.raw.whitney_houston_i_will_always_love_you));
        music.add(new Music("Stevie Wonder", "I just called to say I love you",R.raw.stevie_wonder_i_just_called_to_say_i_love_you));
        music.add(new Music("Taylor Swift", "Love Story",R.raw.taylor_swift_love_story));
        music.add(new Music("Elton John", "Can you feel the love tonight",R.raw.elton_john_can_you_feel_the_love_tonight));
        music.add(new Music("Ed Sheeran", "Thinking out loud",R.raw.ed_sheeran_thinking_out_loud));

        MusicAdapter adapterM = new MusicAdapter(this, music);

        ListView musicView = findViewById(R.id.music_list);

        musicView.setAdapter(adapterM);
        ...
        musicView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer = MediaPlayer.create(LoveActivity.this, song.getAudioResourceId());

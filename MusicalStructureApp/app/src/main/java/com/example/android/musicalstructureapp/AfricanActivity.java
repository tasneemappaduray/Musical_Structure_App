...
public class AfricanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        music.add(new Music("Lady Zamar", "Collide",R.raw.lady_zamar_collide));
        music.add(new Music("Sketchy Bongo ft Kaien Cruz", "Love me in the dark",R.raw.sketchy_bongo_ft_kaieen_cruz_love_me_in_the_dark));
        music.add(new Music("Tiwa Savage ft Don Jazzy", "Eminado",R.raw.tiwa_savage_ft_don_jazzy_eminado));
        music.add(new Music("Brenda Fassie", "Vuli Ndlela",R.raw.brenda_fassie_vuli_ndlela));
        ...
        musicView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer = MediaPlayer.create(AfricanActivity.this, song.getAudioResourceId());

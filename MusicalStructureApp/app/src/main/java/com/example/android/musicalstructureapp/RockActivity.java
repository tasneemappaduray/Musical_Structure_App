...
public class RockActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        music.add(new Music("Nirvana", "Smells like teen spirit",R.raw.nirvana_smells_like_teen_spirit));
        music.add(new Music("Linkin Park", "New Divide",R.raw.linkin_park_new_divide));
        music.add(new Music("Queen", "Bohemian Rhapsody",R.raw.queen_bohemian_rhapsody));
        music.add(new Music("Radiohead", "Creep",R.raw.radiohead_creep));
        music.add(new Music("The Cranberries", "Zombie",R.raw.the_cranberries_zombie));
